...
public class TechNewsController {
    ...
    public String login(@ModelAttribute User user, Model model, HttpServletRequest request) throws Exception {
        ...
        if ((user.getPassword().equals(null) || user.getPassword().isEmpty()) || user.getEmail().equals(null) || user.getEmail().isEmpty()) {
            model.addAttribute("notice", "Email address and password must be populated to login. Please try again.");
            return "login";
        }
        ...
        try {
            ...
            // We will catch an error and notify client that email address is not found
        } catch (NullPointerException e) {
            model.addAttribute("notice", "Email address not found. Please check your email address and try again.");
            return "login";
        }
        ...
        if (isPasswordValid == false) {
            model.addAttribute("notice", "Password does not match. Please try again.");
            return "login";
        }
    ...
    public String signup(@ModelAttribute User user, Model model, HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            model.addAttribute("notice", "No user was found with that email address. Please try again.");
            return "login";
        }
